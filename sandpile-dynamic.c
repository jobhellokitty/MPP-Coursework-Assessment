 ...
 *
 * The reason that allocating arrays at runtime is useful is because,
 * in a parallel program, many of the array dimensions depend on the
 * number of processes. To write a program that runs for different
 * numbers of processes without recompilation therefore requires
...
int main(int argc, char *argv[])
{
  ...
  oldh = (int **) arraymalloc2d(LX+2, LY+2, sizeof(int));
  newh = (int **) arraymalloc2d(LX+2, LY+2, sizeof(int));

  height = (int **) arraymalloc2d(L,L, sizeof(int));
